                ...
                <div class="col-md-12 mb-3">
                    <div class="card">
                        <div class="card-header">
                            <span><i class="bi bi-table me-2"></i></span> Booking List
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="table table-striped data-table2" style="width: 100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = "SELECT * FROM appointments INNER JOIN hospitals ON appointments.hospital_id = hospitals.hospital_id";
                                        ...
                                        if ($total >= 1) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="' . $config['URL'] . '/management/admin/details/bookings/detail/?id=' . $row['user_id'].'">' . $row['user_id'] . '</a></td>
